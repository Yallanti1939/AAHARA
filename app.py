...
def get_cart():
    """
    Returns full cart calculation (items, subtotal, promo, discount, tax, total).
    """
    cart_info = view_cart()
...
def api_menu():
    """
    Returns full menu categorized for visual UI drawer/cards.
    """
...
def modify_cart():
    """
    API endpoint for UI interactive buttons (+ / - / remove / clear / promo code).
    """
    data = request.get_json() or {}
...
def api_orders():
    """
    API endpoint for order history & tracking.
    """
